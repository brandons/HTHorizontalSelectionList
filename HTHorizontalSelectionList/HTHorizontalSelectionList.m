...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
	...
	if ([self.dataSource respondsToSelector:@selector(selectionList:viewForItemWithIndex:)]) {
		...
		for (NSNumber *controlState in [self.fontsByState allKeys]) {
			[((HTHorizontalSelectionListLabelCell *)cell) setFont:self.fontsByState[controlState]
														 forState:controlState.integerValue];
		}
	}
...
- (CGSize)collectionView:(UICollectionView *)collectionView
  ...
  sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
	...
	if ([self.dataSource respondsToSelector:@selector(selectionList:viewForItemWithIndex:)]) {
		...
		CGSize size = [HTHorizontalSelectionListLabelCell sizeForTitle:title withFont:[self fontsByState][@(UIControlStateNormal)]];
